require_relative '../../app/models/maui/course_subject'
	...
	def self.get_complex_sections(session_code, subject, course_num)
		...
		sections_hash.each{ |section_hash|
			...
			section.timeAndLocations.each{ |tal_hash|
				time_and_locations << ComplexSection::TimeAndLocation.new(tal_hash)
			}
			section.timeAndLocations = time_and_locations
