...
#
# Class CourseSubject provides Model to store MAUI data about a CourseSubject object, which represents a course type such as CBE, ECON, CS, etc.
#
...
class CourseSubject
	...
	def <=> (other_subject)
		return self.naturalKey <=> other_subject.naturalKey
	end
